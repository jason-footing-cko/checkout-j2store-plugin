        ...
        if( !$json ){
            ...
            if($respondCharge->isValid()){
                if (preg_match('/^1[0-9]+$/', $respondCharge->getResponseCode())) {
                    ...
                    $order->order_state = JText::_('J2STORE_CONFIRMED');
                }

                else{

                    $errMsg = JText::_('J2STORE_CHECKOUTAPI_MESSAGE_TRANSACTION_UNSUCCESSFUL'). $respondCharge->getResponseMessage();
                ...
                $errMsg = JText::_('J2STORE_CHECKOUTAPI_MESSAGE_TRANSACTION_UNSUCCESSFUL').$respondCharge->getExceptionState()->getErrorMessage();
                $order->order_state_id = 3;
